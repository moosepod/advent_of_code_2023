...
def find_path(s: str, debug=True) -> list[P]:
    ...
    path = {p: d_to_c(d) for p,d in g.a_star_with_max_straight(start,end, heuristic=manhattan_distance,max_straight=2)}
    path[start] = "S"
    dump_grid(g,path)
...
{P(x=6, y=3): '>', P(x=5, y=3): '>', P(x=5, y=2): 'v', P(x=4, y=2): '>', P(x=4, y=3): '^', P(x=3, y=3): '>', P(x=3, y=2): 'S', None: 'x'}
